...
## 📋 To Do
### Backend:
- [x] Refactor Code for Speech-to-text, Media Player & ensure concurancy :link: [refactor-routes](https://github.com/nishanthdass/RAG-fact-checker/tree/refactor-routes)
